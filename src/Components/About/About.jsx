    ...
    <div className='about'>
     ...
     <div className="about-right">
        ...
        <p>Embark on a Transformative educational journey with our 
            ...
            skills, and experiences needed to exce; in the dynamic field of education.
        </p>

        <p>With a focus on innovation, hands-on learning, and personalized mentorship, our
            programs prepare aspiring educators to make a 
            meaningful impact in classrooms and communities.
        </p>

        <p>Wheather you aspire to become a teacher,administrator,
            counselor, or educational  leader, our diverse range of programs offers
            the perfect pathway to achieve your goals and unlock your
